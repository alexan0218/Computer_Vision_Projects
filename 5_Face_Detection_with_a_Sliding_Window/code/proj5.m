...
lambda = 0.0001;
training_sample = [features_pos; features_neg]';
training_label = zeros(1, size(training_sample, 2)) - 1;
training_label(1 : size(features_pos, 1)) = 1;
[w, b] = vl_svmtrain(training_sample, training_label, lambda);
